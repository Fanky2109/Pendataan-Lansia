  ...
  <tr>
    ...
    <td>
      <select class="form-control selectpicker" name="status_user" required>
        ...
        <option value="RT">Sekertaris</option>
      </select>
    </td>
  </tr>
</table>
...
<table class="table table-striped table-middle">
  ...
  <tr>
    <th>RT</th>
    <td>:</td>
    <td><input type="text" class="form-control" name="rt_user" value="003" required></td>
  </tr>
  <tr>
    <th>RW</th>
    <td>:</td>
    <td><input type="text" class="form-control" name="rw_user" value="016" required></td>
  </tr>
</table>
